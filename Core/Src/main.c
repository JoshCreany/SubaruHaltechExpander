...
/* Definitions for ccStalkTask */
osThreadId_t ccStalkTaskHandle;
const osThreadAttr_t ccStalkTask_attributes = {
  .name = "ccStalkTask",
  .priority = (osPriority_t) osPriorityNormal,
  .stack_size = 128 * 4
};
/* Definitions for ccStalkButtonEventQueue */
osMessageQueueId_t ccStalkButtonEventQueueHandle;
const osMessageQueueAttr_t ccStalkButtonEventQueue_attributes = {
  .name = "ccStalkButtonEventQueue"
};
/* USER CODE BEGIN PV */
...
/* USER CODE BEGIN Header_StartCCStalkTask */
/**
  * @brief  Function implementing the cCStalkTask thread.
